        ...
        <x-dl-grid slug="__SLUG__" prefix="plans"
            ...
            @foreach ($plans as $plan)
                ...
                <x-dl-wrapper slug="__SLUG__" prefix="card" :featured="$isFeatured"
                    ...
                    <x-dl-wrapper slug="__SLUG__" prefix="card_price" :featured="$isFeatured"
                    ...
                    <x-dl-wrapper slug="__SLUG__" prefix="card_features_list" tag="ul"
