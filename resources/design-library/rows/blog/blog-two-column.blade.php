{{--
@name Blog - Two Column
@description Two-column blog post grid layout.
@sort 40
--}}
            ...
            <x-dl.card slug="__SLUG__" prefix="post_card" tag="article"
                ...
                <a href="{{ route('blog.show', $post->slug) }}">
                    ...
                    <x-dl.wrapper slug="__SLUG__" prefix="post_title" tag="h3"
                        default-classes="mt-2 text-xl font-semibold text-zinc-900 dark:text-white group-hover:text-primary transition-colors leading-snug">
                        {{ $post->title }}
                    </x-dl.wrapper>
                    <x-dl.wrapper slug="__SLUG__" prefix="post_excerpt" tag="p"
                        default-classes="mt-2 text-zinc-500 dark:text-zinc-400 line-clamp-3">
                        {{ $post->excerpt }}
                    </x-dl.wrapper>
                    <x-dl.wrapper slug="__SLUG__" prefix="post_date"
                        default-classes="mt-4 text-xs text-zinc-400 dark:text-zinc-500">
