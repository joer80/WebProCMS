{{--
@name Featured Card Grid 1
@description Centered heading above a large featured card (background image + text overlay) on the left with three smaller image cards stacked on the right.
@sort 26
--}}
<x-dl.section slug="__SLUG__"
    default-section-classes="py-section px-6 bg-white dark:bg-zinc-900"
    default-container-classes="max-w-container mx-auto grid md:grid-cols-[3fr_2fr] gap-6 items-stretch">
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="featured_card"
        ...
        <x-dl.group slug="__SLUG__" prefix="featured_content"
            ...
            <x-dl.link slug="__SLUG__" prefix="featured_cta"
                ...
                default-url="#"
                default-classes="mt-4 inline-flex items-center text-white font-semibold text-sm underline underline-offset-4 hover:text-white/80 transition-colors" />
        </x-dl.group>
    </x-dl.wrapper>
