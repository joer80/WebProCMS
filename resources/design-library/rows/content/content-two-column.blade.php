...
<section class="py-20 px-6 bg-white dark:bg-zinc-900">
    <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div>
            ...
            <h2 class="mt-3 text-4xl font-bold text-zinc-900 dark:text-white leading-tight">
                {{ content('__SLUG__', 'headline', 'We Are Building the Future of Work', 'text', 'content') }}
            </h2>
            ...
            <a
                href="{{ content('__SLUG__', 'cta_url', '#', 'text', 'call to action') }}"
                @if(content('__SLUG__', 'cta_new_tab', '', 'toggle', 'call to action')) target="_blank" rel="noopener noreferrer" @endif
                class="mt-8 inline-flex items-center text-primary font-semibold hover:text-primary/80 transition-colors"
            >
                {{ content('__SLUG__', 'cta_label', 'Learn more about us', 'text', 'call to action') }} →
            </a>
        </div>
