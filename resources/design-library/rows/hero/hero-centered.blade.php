...
<section class="py-24 px-6 bg-white dark:bg-zinc-900 text-center">
    <div class="max-w-3xl mx-auto">
        <span class="inline-block px-3 py-1 text-xs font-semibold tracking-widest uppercase bg-primary/10 text-primary rounded-full mb-6">{{ content('__SLUG__', 'badge', 'Welcome') }}</span>
        <h1 class="text-5xl sm:text-6xl font-bold text-zinc-900 dark:text-white leading-tight">
            {{ content('__SLUG__', 'headline', 'Your Headline Goes Here') }}
        </h1>
        <p class="mt-6 text-xl text-zinc-500 dark:text-zinc-400 leading-relaxed">
            {{ content('__SLUG__', 'subheadline', 'A compelling subheadline that explains what you do and why it matters to your audience.') }}
        </p>
        <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            >
                {{ content('__SLUG__', 'primary_cta', 'Get Started') }}
            </a>
            <a
            ...
            >
                {{ content('__SLUG__', 'secondary_cta', 'Learn More') }}
            </a>
        </div>
    </div>
</section>
