{{--
@name Events - All Views (List, Month, Day)
@description Interactive events listing with list, month, and day views, search, and upcoming/past tabs.
@sort 5
--}}
<x-dl.section slug="__SLUG__"
    ...
    {{-- View mode switcher --}}
    <x-dl.wrapper slug="__SLUG__" prefix="view_switcher"
        default-classes="flex items-center gap-2 mb-8">
        <x-dl.wrapper slug="__SLUG__" prefix="view_list_btn" tag="button"
        ...
        <x-dl.wrapper slug="__SLUG__" prefix="view_month_btn" tag="button"
        ...
        <x-dl.wrapper slug="__SLUG__" prefix="view_day_btn" tag="button"
    ...
    @if ($eventViewMode === 'list')
        {{-- Search + tabs --}}
        <x-dl.wrapper slug="__SLUG__" prefix="list_filters"
    ...
    @if ($eventViewMode === 'month')
        ...
        @endphp
        <x-dl.wrapper slug="__SLUG__" prefix="month_calendar"
            ...
            {{-- Calendar header --}}
            <x-dl.wrapper slug="__SLUG__" prefix="month_header"
                default-classes="flex items-center justify-between mb-4">
                <x-dl.wrapper slug="__SLUG__" prefix="month_title" tag="h2"
                    default-classes="text-lg font-semibold text-zinc-900 dark:text-zinc-100">
                    {{ $monthCarbon->format('F Y') }}
                </x-dl.wrapper>
                <x-dl.group slug="__SLUG__" prefix="month_nav_buttons"
                    default-classes="flex items-center gap-2">
                    <x-dl.wrapper slug="__SLUG__" prefix="month_prev_btn" tag="button"
                    ...
                    <x-dl.wrapper slug="__SLUG__" prefix="month_next_btn" tag="button"
            ...
            {{-- Day headers --}}
            <x-dl.wrapper slug="__SLUG__" prefix="month_day_headers"
                default-classes="grid grid-cols-7 mb-1">
                @foreach (['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'] as $dayName)
                    <x-dl.wrapper slug="__SLUG__" prefix="month_day_header" tag="div"
            ...
            @endphp
            <x-dl.wrapper slug="__SLUG__" prefix="month_grid"
                ...
                @foreach ($cells as $cell)
                    ...
                    @endphp
                    <x-dl.wrapper slug="__SLUG__" prefix="month_cell" tag="div"
                        ...
                        <x-dl.wrapper slug="__SLUG__" prefix="month_cell_num" tag="span"
                        ...
                        @foreach ($dayEvents as $ev)
                            <x-dl.wrapper slug="__SLUG__" prefix="month_event_label" tag="a"
