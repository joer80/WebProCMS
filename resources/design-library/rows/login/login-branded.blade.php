{{--
@name Login - Branded
@description Login card with primary color header branding.
@sort 80
--}}
<x-dl.section slug="__SLUG__"
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="form_card"
        default-classes="w-full overflow-hidden rounded-card border border-zinc-200 dark:border-zinc-700 shadow-card">
        <x-dl.wrapper slug="__SLUG__" prefix="card_header"
            default-classes="bg-primary px-8 py-8 text-center">
            <x-dl.wrapper slug="__SLUG__" prefix="brand" tag="a"
                href="/"
                default-classes="text-2xl font-bold text-white block mb-1">
                <x-dl.subheadline slug="__SLUG__" prefix="brand_name" tag="span" default="Brand"
                    default-classes="" />
            </x-dl.wrapper>
            <x-dl.subheadline slug="__SLUG__" prefix="header_tagline" tag="p" default="Welcome back"
                default-classes="text-white/80 text-sm" />
        </x-dl.wrapper>
        <x-dl.wrapper slug="__SLUG__" prefix="card_body"
            default-classes="bg-white dark:bg-zinc-900 px-8 py-8">
