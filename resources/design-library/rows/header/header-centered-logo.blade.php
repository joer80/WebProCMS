...
<x-dl.section slug="__SLUG__"
    ...
    default-container-classes="max-w-6xl mx-auto px-6 h-full grid grid-cols-3 items-center">
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="header_button"
        default-classes="flex items-center justify-end gap-3">
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="mobile_panel"
        ...
        x-transition
        style="display:none;"
        default-classes="absolute top-full left-0 right-0 col-span-3 border-t border-zinc-200 dark:border-zinc-800 bg-white/95 dark:bg-zinc-900/95 backdrop-blur shadow-lg px-6 py-4 flex flex-col">
