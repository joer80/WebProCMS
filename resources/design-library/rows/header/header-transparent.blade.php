...
<x-dl.section slug="__SLUG__"
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="header_button"
        ...
        <x-dl.link slug="__SLUG__" prefix="primary_cta"
            ...
            default-url="#"
            default-classes="hidden md:inline-flex px-4 py-2 bg-white text-zinc-900 text-sm font-semibold rounded-lg hover:bg-zinc-100 transition-colors" />
        <x-dl.group slug="__SLUG__" prefix="mobile_btn" tag="button"
            default-classes="md:hidden p-1 rounded text-white/80 hover:text-white transition-colors"
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="mobile_panel"
        ...
        x-transition
        style="display:none;"
        default-classes="absolute top-full left-0 right-0 bg-zinc-900/95 backdrop-blur shadow-lg px-6 py-4 flex flex-col">
        ...
        <x-dl.link slug="__SLUG__" prefix="mobile_cta"
            ...
            default-label="Get Started"
            default-url="#"
            default-classes="mt-4 inline-flex px-4 py-2.5 bg-white text-zinc-900 text-sm font-semibold rounded-lg hover:bg-zinc-100 transition-colors" />
    </x-dl.wrapper>
</x-dl.section>
