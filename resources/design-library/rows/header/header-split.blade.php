...
<x-dl.section slug="__SLUG__"
    ...
    default-sticky="1"
    default-section-classes="h-20 z-50 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 transition-all duration-300"
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="header_button"
        ...
        <x-dl.link slug="__SLUG__" prefix="secondary_cta"
            ...
            default-url="#"
            default-classes="hidden md:inline-flex text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors" />
