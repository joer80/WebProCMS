...
<x-dl.section slug="__SLUG__"
    ...
    default-container-classes="max-w-container mx-auto px-6 flex items-center justify-between">
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="header_button"
        ...
        <x-dl.link slug="__SLUG__" prefix="primary_cta"
            ...
            default-url="/contact"
            default-classes="hidden md:inline-flex text-sm font-semibold text-primary hover:text-primary/80 transition-colors" />
