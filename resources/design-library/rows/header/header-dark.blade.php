...
<x-dl.section slug="__SLUG__"
    ...
    default-sticky="1"
    default-section-classes="h-20 z-50 bg-zinc-900 border-b border-zinc-800 transition-all duration-300"
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="header_button"
        ...
        <x-dl.group slug="__SLUG__" prefix="mobile_btn" tag="button"
            default-classes="md:hidden p-1 rounded text-zinc-400 hover:text-white transition-colors"
    ...
    <x-dl.wrapper slug="__SLUG__" prefix="mobile_panel"
        ...
        x-transition
        style="display:none;"
        default-classes="absolute top-full left-0 right-0 border-t border-zinc-800 bg-zinc-900 shadow-lg px-6 py-4 flex flex-col">
        <x-dl.nav slug="__SLUG__" prefix="mobile_nav"
            default-menu="main-navigation"
            default-classes="flex flex-col"
            default-item-classes="block py-3 text-base font-medium text-zinc-300 hover:text-white border-b border-zinc-800 last:border-0 transition-colors"
            default-active-item-classes="!text-primary" />
