...
<x-dl.section slug="content-featured-card-grid-2:fogk2Z"
    ...
    <x-dl.grid slug="content-featured-card-grid-2:fogk2Z" prefix="cards"
        ...
        @foreach ($cards as $card)
            ...
            <x-dl.card slug="content-featured-card-grid-2:fogk2Z" prefix="card"
                ...
                <x-dl.wrapper slug="content-featured-card-grid-2:fogk2Z" prefix="card_body" default-classes="flex-1 p-4 flex flex-col justify-center">
                ...
                <x-dl.wrapper slug="content-featured-card-grid-2:fogk2Z" prefix="card_image_wrapper"
                    ...
                    @if ($cardImg)
                        <img src="{{ $cardImg }}" alt="{{ $card['image_alt'] }}" class="flex-1 min-h-0 w-full {{ match(content('content-featured-card-grid-2:fogk2Z', 'cards_object_fit', 'cover')) { 'contain' => 'object-contain', 'fill' => 'object-fill', 'none' => 'object-none', default => 'object-cover' } }}">
                    @else
    ...
    <x-dl.buttons slug="content-featured-card-grid-2:fogk2Z"
