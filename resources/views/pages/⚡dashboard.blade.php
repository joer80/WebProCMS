    ...
    <flux:main>
        ...
        @else
            <div class="text-center py-16 text-zinc-500 dark:text-zinc-400">
                <flux:icon name="check-circle" class="size-12 mx-auto mb-4 opacity-30" />
                <flux:text>You're logged in. Contact your administrator if you need access to additional features.</flux:text>
            </div>
        @endif
    </flux:main>
</div>
