...
new #[Layout('layouts.public')] #[Title('Meeting Notes')] class extends Component {
    ...
    // ROW:php:start:content-index:UqYjOJ
    ...
    // ROW:php:end:content-index:UqYjOJ
}; ?>
<div>
{{-- ROW:start:content-index:UqYjOJ --}}
<x-dl.section slug="content-index:UqYjOJ"
    default-section-classes="py-section px-6 bg-white dark:bg-zinc-900"
    default-container-classes="max-w-5xl mx-auto">
    <x-dl.heading slug="content-index:UqYjOJ" prefix="heading" default="Meeting Notes"
        default-tag="h1"
        default-classes="font-heading text-4xl font-bold text-zinc-900 dark:text-white mb-8" />
    <x-dl.wrapper slug="content-index:UqYjOJ" prefix="items_list"
        ...
        @forelse ($this->items as $item)
            <x-dl.card slug="content-index:UqYjOJ" prefix="item_card"
                ...
                <x-dl.wrapper slug="content-index:UqYjOJ" prefix="item_title" tag="a"
                ...
                @if ($item->published_at)
                    <x-dl.wrapper slug="content-index:UqYjOJ" prefix="item_date" tag="span"
        ...
        @empty
            <x-dl.wrapper slug="content-index:UqYjOJ" prefix="empty_state" tag="p"
