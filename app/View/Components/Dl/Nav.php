...
class Nav extends Component
{
    public function __construct(
        ...
        public string $defaultAccordion = '',
        ...
        public string $defaultAccordionItemClasses = '',
    ) {}
    ...
    public static function schemaFields(array $attrs): array
    {
        ...
        return [
            ...
            ['key' => "{$prefix}_accordion", 'default' => $attrs['default-accordion'] ?? ''],
            ...
            ['key' => "{$prefix}_accordion_item_classes", 'default' => $attrs['default-accordion-item-classes'] ?? ''],
