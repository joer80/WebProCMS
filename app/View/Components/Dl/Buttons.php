...
class Buttons extends Component
{
    ...
    public static function schemaFields(array $attrs): array
    {
        return [
            ...
            ['key' => 'primary_button_classes', 'default' => $attrs['default-primary-classes'] ?? 'px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary/90 transition-colors', 'group' => 'buttons', 'subgroup' => 'primary_button', 'button_preset' => true],
            ...
            ['key' => 'secondary_button_classes', 'default' => $attrs['default-secondary-classes'] ?? 'px-6 py-3 border border-zinc-300 dark:border-zinc-600 text-zinc-700 dark:text-zinc-200 font-semibold rounded-lg hover:bg-zinc-50 transition-colors', 'group' => 'buttons', 'subgroup' => 'secondary_button', 'button_preset' => true],
